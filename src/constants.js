...
export const dialogueData = {
  ...
  tv: `That's my TV. I watch YouTube a lot on here. I've been watching tech youtubers a lot recently like :
  ...
  bed: `This where I sleep. Great ideas comes when I'm lying on my bed. When an idea strikes, I often have to write it down or else I won
  't be able to sleep because my mental energy is consumed by it.`,
  ...
  library: `There are a lot of programming books on my shelves. There is even one in french (I speak french also btw).
  I probably only read one of them. Who else compulsively buy technical books without ever finishing them?`,
